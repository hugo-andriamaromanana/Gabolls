from app.game.questions import submit_player_draw_decision
from app.game.phases.counter import solve_counters
from app.game.phases.discard import solve_discard
from app.game.phases.drawing import draw_phase
from app.game.phases.in_hand import in_hand_phase
from app.game.create import create_round
from app.game.spells import play_spell
from app.schemas.card_view import CardView
from app.schemas.errors import UnclearedSpellType
from app.schemas.game_state import GameState
from app.schemas.phase import GamePhaseType
...
async def update_game_state(game_state: GameState) -> GameState:
    ...
    if game_state.game_phase.type is GamePhaseType.NEW_ROUND:
        ...
        draw_decision = await submit_player_draw_decision(game_state.game_phase.player)
